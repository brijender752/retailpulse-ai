...
@dag(dag_id="retailpulse_dbt_analytics",schedule=None,start_date=pendulum.datetime(2026,9,11,tz="UTC"),catchup=False,max_active_runs=1,dagrun_timeout=timedelta(minutes=45),tags=["retailpulse","dbt","analytics"])
